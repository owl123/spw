...
def backtrack_fill(seed, grid, dict_by_length, mask_dict, available, attempt=[0]):
    ...
    for word in candidates:
        ...
        if is_valid_grid_segments(new_grid, dict_by_length):
            ...
            if backtrack_fill(seed, new_grid, dict_by_length, mask_dict, new_available, attempt):
